...
/**
 * Live countdown to `targetDate`. Returns null if the target is missing or
 * already in the past.
 *
 * Updates once per second; cleans up on unmount.
 */
...
/**
 * Renders "Через X дн HH:MM:SS" until the target date passes.
 * Hides itself when the date is missing or already past.
 */
